            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label" name="date">借用日期(15天内)</label>
                            <div  class="col-sm-10">
                        ...
                        <div class="form-group" style="text-align: center">
                            ...
                            <button class="btn btn-default" type="reset">重置</button><font color="red">${msg}</font>
                        </div>
                    </form>
                </div>
